const auto = true; // Mettre ce paramètre sur "true" pour afficher automatiquement le diaporama. Sinon le déclenchement se fait en appuyant sur la touche "p" ou "s" ou en cliquant sur un élément de classe "startSlides"
